#!/usr/bin/env python3
"""Check local pretrained checkpoints, GPU, and ImageNet-C folder structure."""
...
from common.data_utils import discover_imagenet_c_combos, write_dataset_check, load_imagenet_class_mapping
...
def main():
    ...
    checks = {
        ...
        "resnet_local_ckpt_exists": Path(args.resnet_local_ckpt).exists(),
    ...
    print("ResNet checkpoint exists:", checks["resnet_local_ckpt_exists"], args.resnet_local_ckpt)
